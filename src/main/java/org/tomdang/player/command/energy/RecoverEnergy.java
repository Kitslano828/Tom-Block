...
public class RecoverEnergy implements CommandExecutor {

	private final PlayerResourceService playerResourceService;

	public RecoverEnergy(PlayerResourceService playerResourceService) {
	...
	public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
		...
		playerResourceService.restoreEnergy((Player) sender, energySpent);
		sender.sendMessage("You regained " + energySpent +  " energy! Refreshing!");
